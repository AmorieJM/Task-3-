...
namespace SEM2_ASSIGNMENT_TASK1
{
    public partial class rtsGame : Form
    {
        ...
        public class Map
        {
            ...
            public Map(TableLayoutPanel mapGrid)
            {
        ...
        //    //    }
        //    //} 
        //    //DialogResult result = MessageBox.Show("You are about to reset the game.", "Warning!", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning);
        ...
        {
            MessageBox.Show("I tried!", "Ugh", MessageBoxButtons.OK, MessageBoxIcon.Exclamation); //Message to display my sadness
        }
